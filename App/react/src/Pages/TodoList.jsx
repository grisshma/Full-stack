...
const TodoList = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fef9c3] font-['Comic_Sans_MS',_cursive] flex flex-col items-center py-20 relative">
      ...
      <button 
        onClick={() => navigate(-1)}
        className="hidden md:flex absolute left-8 top-1/2 -translate-y-1/2 w-8 h-8 bg-[#fdf5f5] text-black/60 shadow-sm rounded-[4px] items-center justify-center hover:bg-white transition-colors"
      >
